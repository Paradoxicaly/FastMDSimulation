...
from openmm.app import AllBonds, HAngles, HBonds, NoCutoff, PME, Ewald, CutoffNonPeriodic, CutoffPeriodic
...
class TestOpenMMEngineHelpers:
    ...
    def test_select_platform_invalid(self):
        ...
        with patch('openmm.Platform') as mock_platform:
            mock_platform.getPlatformByName.side_effect = Exception("Platform not found")
...
class TestCreateSystemKwargs:
    ...
    def test_create_system_kwargs_invalid_method(self):
        ...
        config = {
            "create_system": {
                "nonbondedMethod": "invalid_method"
            }
        }
